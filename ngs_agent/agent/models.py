...
class ExperimentContext(BaseModel):
    ...
    # Parsed samples from the primary samplesheet, one dict per sample with
    # keys: sample, fastq_r1, fastq_r2, strandedness, condition.
...
class Plan(BaseModel):
    ...
    dry_run: bool = False
    # Upper bound on concurrently executing steps. The executor may schedule
    # fewer when dependencies constrain the graph.
