...
DEFAULT_CONFIG: dict[str, Any] = {
    "llm": "none",
    # Imported lazily to avoid a circular import with the v2 settings module.
    "anthropic_model": None,  # replaced below with DEFAULT_ANTHROPIC_MODEL
...
from ngs_agent.config.settings import DEFAULT_ANTHROPIC_MODEL  # noqa: E402
