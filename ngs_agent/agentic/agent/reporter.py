...
class ReporterAgent:
    ...
    def _fallback_insights(self, plan: Plan, verification: VerificationReport) -> str:
        lines = [
    ...
    def _ai_insights(self, plan: Plan, verification: VerificationReport) -> str:
        if not self.settings.anthropic_api_key:
            return self._fallback_insights(plan, verification)
        ...
        try:
            ...
            logger.info(
                ...
                "Install with `pip install ngs-agent[llm]` to enable AI insights."
            )
            return self._fallback_insights(plan, verification)
...
<html lang="en">
  ...
  <body>
    ...
    <div class="card">
      <h2>AI Insights</h2>
      <pre>{html_escape(ai_insights)}</pre>
    </div>
    <div class="card">
      <h2>Verification</h2>
